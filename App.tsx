...
const stages = [
  ...
  "Running Chunk-Level Local Analysis...",
  "Extracting Deliverables and Owners...",
  "Merging Decision Contexts...",
  "Synthesizing Strategic Summary...",
  "Finalizing Deterministic JSON Export..."
];
...
ACTION MATRIX:
${result.action_items.map((a, i) => `[ ] TASK: ${a.task} | OWNER: ${a.owner} | DEADLINE: ${a.deadline}`).join('\n')}
...
GENERATED BY MEETINGMIND PRO V3.0
  ...
  const downloadReport = () => {
    ...
    a.href = url;
    a.download = `MeetingMind_Report_${fileName.replace(/\.[^/.]+$/, "")}.txt`;
    a.click();
    ...
    <div className="min-h-screen p-4 md:p-10 flex flex-col items-center bg-[#050810] text-gray-200 selection:bg-indigo-500/30">
      <header className="w-full max-w-7xl mb-12 flex justify-between items-end border-b border-white/5 pb-8">
        ...
        <div className="hidden md:flex flex-col items-end gap-1">
          ...
          <span className="text-[9px] text-gray-600 font-bold tracking-tighter">CORE v3.0.0-PRO • NEURAL-SYNC</span>
        </div>
      </header>
      ...
      <main className="w-full max-w-7xl flex-grow">
          ...
          <div className="flex flex-col items-center justify-center py-44 space-y-12 animate-in fade-in duration-700">
            ...
            <div className="text-center space-y-6">
              ...
              <p className="text-gray-400 text-xl max-w-xl mx-auto font-light leading-relaxed">
                Processing <span className="text-indigo-400 font-mono italic px-2 bg-indigo-500/10 rounded">{fileName}</span>. <br/>
                Analyzing hierarchical segments and maintaining context state...
              </p>
            </div>
          </div>
        )}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 animate-in fade-in slide-in-from-bottom-8 duration-1000 pb-20">
              ...
              <div className="glass p-14 rounded-[56px] shadow-2xl border-white/5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {result.action_items.map((item, i) => (
                    <div key={i} className="flex flex-col p-10 rounded-[32px] bg-white/[0.01] border border-white/5 hover:border-indigo-500/40 hover:bg-white/[0.03] transition-all duration-700 group relative">
                      <div className="absolute top-0 right-0 p-8 opacity-0 group-hover:opacity-100 transition-all"><CheckIcon /></div>
                      <div className="text-[9px] font-black text-gray-600 uppercase tracking-[0.3em] mb-8 border-b border-white/5 pb-3">Item Segment {String(i+1).padStart(2, '0')}</div>
            ...
            <aside className="lg:col-span-4 space-y-12">
              ...
              <div className="space-y-8">
                <div className="glass p-10 rounded-[44px] shadow-2xl border-white/5 group">
                  <div className="flex justify-between items-center mb-8">
                    <h3 className="text-[10px] font-black uppercase tracking-[0.4em] text-emerald-400 flex items-center gap-3">
                      <div className="w-2 h-2 rounded-full bg-emerald-500"></div> Comms: WhatsApp
                    </h3>
                    <button 
                ...
                <div className="glass p-10 rounded-[44px] shadow-2xl border-white/5 group">
                  <div className="flex justify-between items-center mb-8">
                    <h3 className="text-[10px] font-black uppercase tracking-[0.4em] text-indigo-400 flex items-center gap-3">
                      <div className="w-2 h-2 rounded-full bg-indigo-500"></div> Comms: Email
                    </h3>
                    <button 
        ...
        {state === "error" && (
          <div className="glass border-red-500/40 p-24 rounded-[72px] text-center max-w-4xl mx-auto shadow-2xl bg-gradient-to-b from-red-500/[0.03] to-transparent relative">
